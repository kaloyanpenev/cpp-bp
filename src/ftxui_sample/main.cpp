...
// configuration step. It creates a namespace called `cpp_bp`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", cpp_bp::cmake::project_name, cpp_bp::cmake::project_version) };
